...
#input training data is split into 50,000 training and 10,000 validation set
x_train_train=x_train[0:50000]
...
for activation in activations:
    ...
    output_log ='\nFor combination of with activation as '+activation+' batch size:'+str(batch_size)+'learning rate:'+str(learning_rate)+'\n'+\
